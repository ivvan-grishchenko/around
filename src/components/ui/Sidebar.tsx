...
const SIDEBAR_SHEET_STYLE = {
	'--sidebar-width': SIDEBAR_WIDTH_MOBILE,
};

const tooltipProviderStyle = (style?: CSSProperties) => ({
	'--sidebar-width': SIDEBAR_WIDTH,
	'--sidebar-width-icon': SIDEBAR_WIDTH_ICON,
	...style,
});
const sidebarSkeletonStyle = (width: string) => ({
...
const SidebarProvider = ({
	...
	const setOpen = useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			else setOpenInternal(openState);
		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					style={tooltipProviderStyle(style)}
					className={cn(
		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				<SheetContent
					...
					style={SIDEBAR_SHEET_STYLE as CSSProperties}
					side={side}>
	...
	return (
		<div
			...
			<Skeleton
				...
				style={sidebarSkeletonStyle(width) as CSSProperties}
			/>
		</div>
	);
};
