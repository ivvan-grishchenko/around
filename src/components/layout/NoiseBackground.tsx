/* oxlint-disable id-length, no-magic-numbers, max-statements */
...
const gradientVariants = {
	default: ['var(--chart-1)', 'var(--chart-2)', 'var(--chart-3)'],
	forest: ['rgb(50, 200, 100)', 'rgb(100, 180, 150)', 'rgb(50, 150, 200)'],
	ocean: ['rgb(50, 150, 255)', 'rgb(100, 220, 200)', 'rgb(50, 100, 255)'],
	sunset: ['rgb(255, 100, 50)', 'rgb(255, 50, 150)', 'rgb(200, 100, 255)'],
} as const;
...
const GradientLayer = ({
	...
	const style = useMemo(() => ({ background, opacity }), [background, opacity]);

	return <motion.div className="absolute inset-0" style={style} />;
};
...
const noisePatterStyle: CSSProperties = { mixBlendMode: 'overlay' };
...
export const NoiseBackground = ({
	...
	const style: CSSProperties = useMemo(
		() => ({ '--noise-opacity': noiseIntensity }) as CSSProperties,
		[noiseIntensity]
	);
	const topGradientStyle = useMemo(
		...
		[gradientColors, animating, topGradientX]
	);
